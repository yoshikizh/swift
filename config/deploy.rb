...
set :scm_passphrase, "9f1e3b0d"
set :scm_password,   "9f1e3b0d"
set :password,   "9f1e3b0d"
...
namespace :deploy do
  ...
  task :restart, :roles => :app, :except => { :no_release => true } do
    run "kill -USR2 `cat /var/www/linju-production/shared/pids/unicorn_production_app.pid`"
  end

  task :reload, :roles => :app, :except => { :no_release => true } do
    run "kill -HUP `cat /var/www/linju-production/shared/pids/unicorn_production_app.pid`"
  end
